...
/// <summary>
/// Tests for ChangesMonitor.Create("Id2", root, false, false).
/// </summary>
[TestClass]
public class ChangesMonitor_Id2_MonitorOnlyMarkedPropertiesFalse_UseWeakEventsFalse_Tests
{
    public ChangesMonitor_Id2_MonitorOnlyMarkedPropertiesFalse_UseWeakEventsFalse_Tests()
    {
        _Root = NotifyingObject.CreateTreeWith3Layers();

        _ChangesMonitor = ChangesMonitor.Create(_Root, "Id2", false, false);
