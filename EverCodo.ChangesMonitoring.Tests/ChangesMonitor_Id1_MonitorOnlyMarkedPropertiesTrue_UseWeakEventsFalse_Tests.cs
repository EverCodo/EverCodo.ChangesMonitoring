...
/// <summary>
/// Tests for ChangesMonitor.Create("Id1", root, true, false).
/// </summary>
[TestClass]
public class ChangesMonitor_Id1_MonitorOnlyMarkedPropertiesTrue_UseWeakEventsFalse_Tests
{
    public ChangesMonitor_Id1_MonitorOnlyMarkedPropertiesTrue_UseWeakEventsFalse_Tests()
    {
        _Root = NotifyingClass.CreateTreeWith3Layers();

        _ChangesMonitor = ChangesMonitor.Create("Id1", _Root, true, false);
